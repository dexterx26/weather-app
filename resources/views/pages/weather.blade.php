...
<body class="hold-transition" style="background: url({{url('public/images/background.png')}});background-repeat: no-repeat;
                  ...
                  $.ajax({
                    ...
                    success: function(data){
                      ...
                      for(var i=0;i<5;i++){
                        ...
                        html+='<img style="width:5vw;height:10vh" src="https://openweathermap.org/img/wn/'+forecastIcon+'@2x.png" class="weather-margin-top" alt="">';
                        ...
                        html2+='<img style="width:5vw;height:10vh" src="https://openweathermap.org/img/wn/'+dailyIcon+'@2x.png" class="weather-margin-top" alt="">';
